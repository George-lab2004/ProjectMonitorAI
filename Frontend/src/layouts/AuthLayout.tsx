...
export default function AuthLayout() {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-base-300 text-base-content relative">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-12 flex-col gap-y-10 relative overflow-hidden text-white">
        {/* 🔴 BACKGROUND EFFECTS */}
        ...
        <svg
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[750px] pointer-events-none z-0 opacity-45 overflow-visible"
          viewBox="0 0 500 500"
        >
          <defs>
            {/* Inner Glowing Core Gradient */}
          ...
          {/* Curved Latitude Rings (Horizontal Sphere Grids) */}
          ...
          {/* Curved Longitude Rings (Vertical Sphere Arcs) */}
          ...
          {/* Pulsing Intersecting Data Nodes */}
        ...
        <div className="flex-col relative z-10 flex justify-start items-start gap-5">
          <div className="flex-col text-7xl tracking-[-0.1em] leading-[1em]">
            Your team, <br />
            <span className="text-teal-400">focused</span> <br />
            every day. <br />
          </div>
          <div className="flex-col">
            <p className="text-md font-bold tracking-wide text-text-secondary w-[70%]">
          ...
          <div className="flex flex-col gap-3 w-full max-w-lg">
            ...
            <div className="flex items-center justify-between gap-3 text-white bg-white/5 backdrop-blur-md border border-rose-500/20 rounded-xl p-3 transition-all hover:translate-x-1">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm">Atlas Redesign — deadline risk</p>
                  <p className="text-xs text-slate-400">AI flagged · 38% done · 2 days left</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between gap-3 text-white bg-white/5 backdrop-blur-md border border-emerald-500/20 rounded-xl p-3 transition-all hover:translate-x-1">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm">Sara K. completed a task</p>
                  <p className="text-xs text-slate-400">Auth flow screens · just now</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between gap-3 text-white bg-white/5 backdrop-blur-md border border-slate-500/20 rounded-xl p-3 transition-all hover:translate-x-1">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm">Morning AI scan complete</p>
                  <p className="text-xs text-slate-400">No issues detected · 2 mins ago</p>
                </div>
              </div>
        ...
        {/* Footer Credit */}
        <p className="text-sm text-slate-500">© 2026 Project Monitor AI</p>
      </div>
